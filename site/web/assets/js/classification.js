var count = 1;
          ...
          if(data.length >= 1) {
            ...
            for(var i = 0; i < data.length; i++) {
              $('.classifications').append('<div class="categories">\
                    ...
                    <a class="update-classification" href="/'+parentName+'/'+projectName+'/'+data[i]['id']+'/update">\
  ...
  var updateClassification = function(classificationDetails, parentName, projectName) {
    insertClassification(classificationDetails, parentName, projectName);
