 ...
 */
final class Version20190707152343 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE NotifiableNotification ADD CONSTRAINT FK_5D38ED56EF1A9D84 FOREIGN KEY (notification_id) REFERENCES Notification (id)');
    }
